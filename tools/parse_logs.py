...
def parse_server_args(content: str) -> dict[str, Any] | None:
    """
...
class LogParser:
    ...
    def _detect_logs_location(self) -> Path | None:
        """
        检测日志文件的位置
    ...
    def _parse_worker_log(self, log_path: Any) -> dict[str, Any]:
        ...
        try:
            with open(actual_path, errors="ignore") as f:
                content = f.read()
    ...
    def _parse_benchmark(self) -> dict[str, Any]:
        ...
        try:
            with open(self.benchmark_path, errors="ignore") as f:
                content = f.read()
